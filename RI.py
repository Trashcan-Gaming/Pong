...
#
#     #comput RELU Activation function
#     #on 2d convolutions
#     #given 4D inputs and filter tensors
#
#     conv1 = tf = tf.nn.relu(tf.nn.conv2d(s, W_conv1, strides[1,4,4,1] padding = "VALID"))
#     conv2 = tf = tf.nn.relu(tf.nn.conv2d(s, W_conv1, strides[1,4,4,1] padding = "VALID"))
#     conv3 = tf = tf.nn.relu(tf.nn.conv2d(s, W_conv1, strides[1,4,4,1] padding = "VALID"))
#
#     conv3_flat = tf.reshape(conv3, [-1, 3136])
#     fc_4 = tf.nn.relu(tf.matmul(conv3_flat, W_fc4 + b_fc4))
#     fc_5 = tf.matmul(fc_5, W_fc5) + b_fc5
#
#     return s fc_5
#
# def main():
