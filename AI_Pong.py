...
def init():
    ...
    paddle1_pos = [int(HALF_PAD_WIDTH - 1),int(HEIGHT/2)]
    paddle2_pos = [int(WIDTH +1 - HALF_PAD_WIDTH),int(HEIGHT/2)]
    l_score = 0
    r_score = 0
...
def draw(canvas):
    ...
    paddle2_pos[1] = pong.updatePaddle2(paddle2_pos[1], ball_pos[1])
